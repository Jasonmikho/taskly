...
export default function Register({ setUser, switchToLogin, onClose }) {
      ...
      const interval = setInterval(async () => {
        try {
          ...
          if (currentUser && currentUser.emailVerified) {
            console.log('Email verified! Signing user in automatically...');
  ...
  async function handleRegister(e) {
    ...
    try {
      ...
      setSuccess('Registration successful! Please check your email (including spam folder) to verify your account. You will be automatically logged in once verified.');
        ...
        <form className="login-glass-card" onSubmit={handleRegister}>
          ...
          {success && (
            <div className="login-success">
              {success}
              {polling && <div style={{ marginTop: '10px', fontSize: '14px' }}>
